...
Its TCP since we use SOCK_STREAM for the socket call
3. The client is going to send some data to the server. Where does it get this
data from? How can you tell in the code? we get the data from the read call in
line 53
4. How does the client program end? How can you tell that in the code?
by the user inputting cntrl d, it will end the while loop
*/
#include <arpa/inet.h>
#include <stdio.h>
#include <stdlib.h>
